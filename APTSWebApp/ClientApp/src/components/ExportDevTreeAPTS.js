...
const ExportDevTreeAPTS = (props) => {
    return (
        <div style={{ marginBottom: '5px' }}>
            <ExcelFile filename="exportedDevTreeAPTS" element={<button className="btn btn-outline-success btn-sm">Excel</button>}>
                <ExcelSheet data={props.data} name="Лист 1">
                    ...
                    <ExcelColumn label="Устройство РЗА" value="dev" />
...
export default ExportDevTreeAPTS;